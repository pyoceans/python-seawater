...
the new
| `TEOS-10 <http://www.teos-10.org/>`__.
...
| positions (See the table below). The MatlabTM version does some
guessing at
...
| script to test the Python library against an available MatlabTM
library (all
| inside Python via the oct2py package). The current version was tested
against
| seawater v3.3.

            python test\_octave.py ./path\_to\_sewater\_toolbox

| More information:
|  http://pythonhosted.org/seawater

.. |Build| image:: https://badge.fury.io/py/seawater.png
