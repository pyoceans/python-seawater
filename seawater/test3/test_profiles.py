...
import numpy as np
import seawater.gibbs as gsw2
import seawater.gibbs3 as gsw
from seawater.gibbs3.utilities import Dict2Struc
...
datadir = os.path.join(os.path.dirname(gsw2.__file__), 'data')
