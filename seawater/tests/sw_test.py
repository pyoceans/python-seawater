...
def test(fileout="python-test.txt"):
    ...
    UN_ptmp = np.array(
        [
            [0, -0.3061, -0.9667, 0, -0.3856, -1.0974],
    ...
    UN_cp = np.array(
        [
            [4048.4, 3896.3, 3807.7, 3986.5, 3849.3, 3769.1],
    ...
    UN_svel = np.array(
        [
            [1435.8, 1520.4, 1610.4, 1449.1, 1534.0, 1623.2],
